		...
		new FLBuilderPostCarousel({
			...
			settings: {
				...
				slideMargin: 30,
					...
					$('.fl-node-5903c2b03d41a .fl-post-carousel-navigation a').addClass('disabled');
					$('.fl-node-5903c2b03d41a .bx-controls .bx-pager-link').addClass('disabled');
				},
				onSlideAfter: function( ele, oldIndex, newIndex ) {
					$('.fl-node-5903c2b03d41a .fl-post-carousel-navigation a').removeClass('disabled');
					$('.fl-node-5903c2b03d41a .bx-controls .bx-pager-link').removeClass('disabled');
				}
			}
		});
