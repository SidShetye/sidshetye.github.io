var wpAjaxUrl = 'https://www.crypteron.com/wp-admin/admin-ajax.php';var flBuilderUrl = 'https://www.crypteron.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'https://www.crypteron.com/wp-content/plugins/bb-plugin/',
		wpAjaxUrl : 'https://www.crypteron.com/wp-admin/admin-ajax.php'
	},
	breakpoints : {
		small  : 768,
		medium : 992	},
...
(function($) {
	...
	$('.fl-node-5f52bb4b213a5 .fl-slider-next').empty();
	$('.fl-node-5f52bb4b213a5 .fl-slider-prev').empty();

	// Create the slider and assign an instance to a variable.
	var testimonials = $('.fl-node-5f52bb4b213a5 .fl-testimonials').bxSlider({
		autoStart : 1,
		auto : true,
		adaptiveHeight: true,
		pause : 6000,
		...
		speed : 500,
		pager : 1,
		nextSelector : '.fl-node-5f52bb4b213a5 .fl-slider-next',
		prevSelector : '.fl-node-5f52bb4b213a5 .fl-slider-prev',
		nextText: '<i class="fas fa-chevron-circle-right"></i>',
		prevText: '<i class="fas fa-chevron-circle-left"></i>',
		controls : 0,
		onSliderLoad: function(currentIndex) {
			$('.fl-node-5f52bb4b213a5 .fl-testimonials').addClass('fl-testimonials-loaded');
			$('.fl-node-5f52bb4b213a5 .fl-slider-next a').attr('aria-label', 'Next testimonial.' );
			$('.fl-node-5f52bb4b213a5 .fl-slider-prev a').attr('aria-label', 'Previous testimonial.' );
		},
		...
		onSlideBefore: function(ele, oldIndex, newIndex) {
			$('.fl-node-5f52bb4b213a5 .fl-slider-next a').addClass('disabled');
			$('.fl-node-5f52bb4b213a5 .fl-slider-prev a').addClass('disabled');
			$('.fl-node-5f52bb4b213a5 .bx-controls .bx-pager-link').addClass('disabled');
		},
		onSlideAfter: function( ele, oldIndex, newIndex ) {
			$('.fl-node-5f52bb4b213a5 .fl-slider-next a').removeClass('disabled'); 
			$('.fl-node-5f52bb4b213a5 .fl-slider-prev a').removeClass('disabled'); 
			$('.fl-node-5f52bb4b213a5 .bx-controls .bx-pager-link').removeClass('disabled');
		},
		onSlideNext: function(ele, oldIndex, newIndex) {
			$('.fl-node-5f52bb4b213a5 .fl-slider-next').attr( 'aria-pressed', 'true' );
			$('.fl-node-5f52bb4b213a5 .fl-slider-prev').attr( 'aria-pressed', 'false' );
		},
		onSlidePrev: function(ele, oldIndex, newIndex) {
			$('.fl-node-5f52bb4b213a5 .fl-slider-next').attr( 'aria-pressed', 'false' );
			$('.fl-node-5f52bb4b213a5 .fl-slider-prev').attr( 'aria-pressed', 'true' );
		}
	});
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-589271e6cc811 .fl-photo-img' )
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-58927351b2e76 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-57d72a8c67b7a .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-56d1458a3dc99 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-57d8662098127 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery( document ).ready(function( $ ){
    $('.trigger-hover-main a').hover(function(){
       $('#play-btn-main a').addClass('hover');
    }, function(){
        $('#play-btn-main a').removeClass('hover');
    });
    
     $('.trigger-hover-bottom a').hover(function(){
       $('#play-btn-bottom a').addClass('hover');
    }, function(){
        $('#play-btn-bottom a').removeClass('hover');
    });
    /*
    $('.play-trigger').hover(function(){
        $('#monitor-play-black img').fadeTo(200, 0);
        $('#monitor-play-red img').fadeTo(200, 1);
    }, function(){
        $('#monitor-play-black img').fadeTo(200, 1);
        $('#monitor-play-red img').fadeTo(200, 0);
    });*/
    
    $('a[href="#close-alert"]').click(function(e){
       e.preventDefault();
       $('#alert-bar').remove();
    });
});
